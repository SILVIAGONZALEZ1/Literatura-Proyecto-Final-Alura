package com.LiterAlura.Literatura.principal;
...
public class Principal {
    ...
    public void ejecutar(){
        ...
        while(true) {
            ...
            switch (opcionMenu) {
                case 0 -> {System.out.println("¡Ya te vas aun tengo mas libros para mostra ok, vuelve pronto!");escaner.close();System.exit(0);}
                ...
                default -> System.out.println("Opción incorrecta. Vamos, elige una opción entre 1 y 6.");
            }
        }
    }
    ...
    private void buscarPrimerLibroPorTitulo() {
        ...
        Optional<LibroDto> respuesta = GutendexService.consultarCoincidenciasTituloAutor(consulta);
